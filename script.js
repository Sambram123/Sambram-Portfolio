...
const BG_WORDS = ['SAMBRAM', 'SANGALAD', 'CODING', 'MERN', 'AI', 'ML', 'REACT', 'PYTHON', 'OPENCV', 'YOLO'];
...
/* ---------------- about stats + split panels: depth pop-in ---------------- */
gsap.utils.toArray('.about-stats, .split').forEach(el => {
  gsap.fromTo(el,
